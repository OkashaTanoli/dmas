...
function Team() {
    ...
    const data = [
        { color: 'bg-[#ff5869]', image: Img, title: 'Chief Executive Officer', sub_title: 'CEO', list: ['Clinical Psychologist', 'Transformation Coach', 'Entrepreneur', 'Author', 'Motivational Speaker', 'IT Engineer', 'Director of IIRDC'] },
        { color: 'bg-[#52cabe]', image: Img, title: 'Chief Tenchnology Officer', sub_title: 'CTO', list: ['Serial Entrepreneur', 'Enabler', 'Career Counselor', 'Technology Consultant', 'IT Engineer', 'Co-Founder & Director of DIA'] },
        { color: 'bg-[#fec631]', image: Img, title: 'Chief Operating Officer', sub_title: 'COO', list: ['Industry Consultant', 'Professional Expertise in Startups, Value Creation', 'Career Counselor', 'Technology Consultant', 'IT Engineer', 'HEC official Resource Person for FDP'] },
    ]

    const data2 = [
        { color: 'bg-[#ff5869]', image: Img, title: 'Syed Ehtisham Uddin', sub_title: 'Sr. Web Developer' },
        { color: 'bg-[#52cabe]', image: Img, title: 'Muhammad Zubair Ilyas', sub_title: 'Sr. Graphic Designer' },
        { color: 'bg-[#fec631]', image: Img, title: 'Huzaifa Ahmed Siddiqui', sub_title: 'Sr. Web Developer' },
    ]
                        ...
                        data.map((val, index) => {
                            return (
                                <div key={index} className='shadow-2xl rounded-3xl overflow-hidden flex flex-col'>
                                    ...
                                    <ul className='mt-14 list-outside ml-5 list-disc p-7'>
                                        {
                                    ...
                                    <div className='flex-grow flex items-end justify-center'>
                                        <Image src={val.image} alt='img' className='w-[70%]' />
                                    </div>
                                </div>
                            )
                        })
